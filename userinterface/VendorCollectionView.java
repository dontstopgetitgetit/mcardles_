...
public class VendorCollectionView extends View implements ActionListener, MouseListener
{
	...
	//--------------------------------------------------------------------------
	public VendorCollectionView(IModel iitc)
	{
		super(iitc, "VendorCollectionView");
